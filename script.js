...
add_task.addEventListener('click', () => {
    if (input_area.value.trim() === "") {
        ...
        child.innerHTML = length + ". <h2>" + input_area.value + "</h2> <strong>dueDate:</strong>" + a + ", Time:" + time;
        ...
        changeDeadlineButton.addEventListener('click', () => {
            ...
            newDeadlineInput.addEventListener('change', () => {
                child.textContent = length + ". " + input_area.value +" Deadline: " + newDeadlineInput.value;
            });
